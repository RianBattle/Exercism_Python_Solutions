...
public class WeatherStation {
  ...
  public Outlook ShortTermOutlook =>
    _reading.Equals(new Reading()) ? throw new ArgumentException() :
    _reading.Pressure < 10m && _reading.Temperature < 30m ? Outlook.Cool :
    _reading.Temperature > 50 ? Outlook.Good : Outlook.Warm;
  ...
  public State RunSelfTest() => _reading.Equals(new Reading())
      ? State.Bad
      : State.Good;
}
